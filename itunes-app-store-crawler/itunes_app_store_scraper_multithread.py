...
def description_get(soup):
    ...
    #app description is the text in the <p> tag in the "content" <div>
    descriptionDiv = soup.find('div', {'metrics-loc': 'Titledbox_Description'})
    return descriptionDiv.find("p").text
...
def app_info(soup,site):
    ...
    try:
        ...
        description = description_get(soup)
        ...
        return (title,developer,description,price,category,size,seller,stars,rating,site)
    except:
